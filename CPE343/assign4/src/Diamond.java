...
public class Diamond extends AbstractShape
{
	...
	/**
	 * Constructor creates a new diamond by specifying an x,y for the top point of
	 * the diamond, plus vertical and horizontal axis lengths.
	 * 
	...
	/**
	 * Calculate the perimeter of this diamond. This is four times the length of one
	 * side.
	 * 
	...
	/**
	 * Calculate the area of this diamond This is the product of the axes, divided
	 * by 2.
	 * 
	 * @return area value
	 */
	...
	/**
	 * Override toString for gives more useful information about the shape
	 */
	public String toString()
	{
		String information = "Diamond at x=" + anchor.x + ",y=" + anchor.y + " with horizontalAxis " + horizontalAxis
				+ " with verticalAxis " + verticalAxis;
		return information;
	}
