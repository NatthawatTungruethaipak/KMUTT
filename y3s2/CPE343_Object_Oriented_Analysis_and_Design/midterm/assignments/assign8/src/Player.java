 ...
 * Player.java
 *
 * This class represents a single player in the Scrabble game. Currently this
 * class is incomplete. All it can do is draw random tiles.
 *
 * Created by Sally Goldin, 2 October 2017 Modified by Natthawat Tungruethaipak,
 * 18 March 2020 added getName() method
 * 
 */
public class Player
{
	 ...
	 * @return true if successful, false if error Error could involve there are not
	 *         enough tiles left, or the user asking for too many tiles
	 */
	...
	/**
	 * Return tile with highest score. Used to determine player who will go first.
	 * 
