...
public class Graph
{
     ...
     */
    protected boolean edgeExists(String key1, String key2)
    {
    ...
    /** Insert a new edge object into the hash table for a key
     * Factorization of addEdge.
     * @param  key  Key for the first vertex in the edge
     * @param  e    Edge object to be inserted
     */
    protected void insertEdge(String key, Edge e)
    {
	ArrayList<Edge> myEdges = edges.get(key);
	if (myEdges == null) /* no previous edges */
	{
	    myEdges = new ArrayList<Edge>(); /* create new list */
	    edges.put(key,myEdges);          /* put into the hash table */
	}
	myEdges.add(e);
    }
