...
/**
 * S * AbstractShape class. Intended to serve as a superclass (generalization)
...
public abstract class AbstractShape
{
	...
	/**
	 * Constructor increments counter, sets shapeId, puts shape into the allFigures
	 * list, and sets the color. These operations will occur regardless of the type
	 * of shape.
	 */
	...
	/**
	 * Move the shape to a new location, specified by the passed x and y
	 * coordinates. We can do this in a general manner by calculating the difference
	 * between the old and new locations in X and Y directions, then adding this
	 * difference to each point. We also need to change the anchor point data item.
	 * 
	...
	/**
	 * Draw the shape. This will only work correctly for closed shapes with a finite
	...
	/**
	 * static method to draw all the shapes that have been created so far.
	 * 
	 * @param graphics Graphics context for drawing.
	 */
