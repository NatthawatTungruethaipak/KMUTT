 ...
 * data.
 *
 * Modified by Natthawat Tungruethaipak, ID 60070503426 on 1 Feb 2020
 */
...
//	private static Color colors[] = { Color.RED, Color.GREEN, Color.BLUE, Color.MAGENTA, Color.ORANGE };
	...
	{
		oneside = side; // side of square
		anchor = new Point(x, y); // use with abstract shape to use as reference
		vertices.add(new Point(x, y)); // upper left
