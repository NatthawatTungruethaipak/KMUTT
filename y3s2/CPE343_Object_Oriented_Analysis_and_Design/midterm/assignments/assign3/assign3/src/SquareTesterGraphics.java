 ...
 *
 * Created by Sally Goldin, 9 August Modified for Exercise 2. Now each figure
 * can draw itself. 19 Aug 2017
 */
public class SquareTesterGraphics
{
	 ...
	 * new triangles, and displays them. Then prints the perimeter and area as well.
	 */
